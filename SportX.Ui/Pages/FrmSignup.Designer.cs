...
partial class FrmSignup
{
    ...
    private void InitializeComponent()
    {
        ...
        labelName.Location = new Point(1053, 85);
        ...
        // textBoxName
        // 
        textBoxName.Location = new Point(573, 80);
        ...
        labelNationalCode.Location = new Point(1053, 133);
        ...
        // textBoxNationalCode
        // 
        textBoxNationalCode.Location = new Point(573, 128);
        ...
        labelPhone.Location = new Point(1053, 180);
        ...
        // textBoxPhone
        // 
        textBoxPhone.Location = new Point(573, 175);
        ...
        labelGender.Location = new Point(1053, 290);
        ...
        labelDateOfBirth.Location = new Point(389, 135);
        ...
        // textBoxDateOfBirth
        // 
        textBoxDateOfBirth.Location = new Point(194, 130);
        ...
        // buttonSignUp
        // 
        buttonSignUp.Location = new Point(461, 447);
        ...
        dataGridViewAthletes.Location = new Point(0, 584);
        ...
        label1.Location = new Point(1053, 397);
        ...
        panel1.Location = new Point(756, 278);
        panel1.Name = "panel1";
        ...
        panel2.Location = new Point(756, 383);
        panel2.Name = "panel2";
        ...
        // textBoxId
        // 
        textBoxId.Location = new Point(859, 32);
        ...
        label2.Location = new Point(1053, 37);
        ...
        groupBox1.Size = new Size(1133, 75);
        ...
        // buttonSearch
        // 
        buttonSearch.Location = new Point(414, 25);
        ...
        // textBoxSearch
        // 
        textBoxSearch.Location = new Point(517, 523);
        ...
        label3.Location = new Point(997, 528);
        ...
        // buttonPayments
        // 
        buttonPayments.Location = new Point(173, 447);
        ...
        // textBoxAddress
        // 
        textBoxAddress.Location = new Point(573, 228);
        ...
        label4.Location = new Point(1053, 233);
        ...
        // textBoxEpc
        // 
        textBoxEpc.Location = new Point(666, 447);
        ...
        label5.Location = new Point(1053, 452);
        ...
        // buttonEpc
        // 
        buttonEpc.Location = new Point(579, 442);
        ...
        // buttonDelete
        // 
        buttonDelete.Location = new Point(287, 447);
        ...
        labelCurrentPlan.Location = new Point(1050, 342);
        labelCurrentPlan.Margin = new Padding(4, 0, 4, 0);
        labelCurrentPlan.Name = "labelCurrentPlan";
        labelCurrentPlan.Size = new Size(84, 25);
        labelCurrentPlan.TabIndex = 29;
        labelCurrentPlan.Text = "برنامه آخر";
        // 
        // textBoxCurrentPlan
        // 
        textBoxCurrentPlan.Location = new Point(573, 337);
        textBoxCurrentPlan.Margin = new Padding(4, 5, 4, 5);
        textBoxCurrentPlan.Name = "textBoxCurrentPlan";
        textBoxCurrentPlan.ReadOnly = true;
        textBoxCurrentPlan.Size = new Size(471, 31);
        textBoxCurrentPlan.TabIndex = 30;
        // 
        // labelEndDate
        // 
        labelEndDate.AutoSize = true;
        labelEndDate.Location = new Point(418, 342);
        labelEndDate.Margin = new Padding(4, 0, 4, 0);
        labelEndDate.Name = "labelEndDate";
        labelEndDate.Size = new Size(89, 25);
        labelEndDate.TabIndex = 31;
        labelEndDate.Text = "تاریخ پایان";
        // 
        // textBoxEndDate
        // 
        textBoxEndDate.Location = new Point(291, 337);
        textBoxEndDate.Margin = new Padding(4, 5, 4, 5);
        textBoxEndDate.Name = "textBoxEndDate";
        textBoxEndDate.ReadOnly = true;
        textBoxEndDate.Size = new Size(128, 31);
        textBoxEndDate.TabIndex = 32;
        // 
        // labelRemainingSessions
        // 
        labelRemainingSessions.AutoSize = true;
        labelRemainingSessions.Location = new Point(180, 342);
        labelRemainingSessions.Margin = new Padding(4, 0, 4, 0);
        labelRemainingSessions.Name = "labelRemainingSessions";
        labelRemainingSessions.Size = new Size(106, 25);
        labelRemainingSessions.TabIndex = 33;
        labelRemainingSessions.Text = "جلسات باقی";
        // 
        // textBoxRemainingSessions
        // 
        textBoxRemainingSessions.Location = new Point(83, 337);
        ...
        textBoxRemainingSessions.Size = new Size(91, 31);
